        ...
        <div className="">
            <div className="w-2/6 text-center ">
                <div className="flex flex-cols items-center">
                    ...
                    <div className="w-1/3">
                            <form>
                                <input onChange={handleQtyChange}  type="text" value={qty} className="border-2 border-gray-300 w-12 text-center rounded-md"></input>
                            </form>
                    </div>
            ...
            <div onClick={()=>route.push('/payment')}>pindah page payment</div>
        </div>
    )
}