function Register({onRegis}:{onRegis:any}){


    return(
        <div className="invisible fixed w-full justify-center" id="regis-show">
            <div className="m-10 mt-20 w-80 p-5 rounded-md shadow-lg bg-white border ">
                <div className="w-full text-end">
                    <i className="fa fa-close text-lg text-end" onClick={()=>onRegis()}/>
                </div>
